...
Check that it works by going to the following link in the browsercheck that it works by going to the following link in the browser: `http://localhost/wordpress`.
